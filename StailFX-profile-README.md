...
#### GymBro — fitness app (CEO + Backend, private)

- 🏆 Выиграли грант **1 000 000 ₽** от ФСИ на конкурсе **«Студенческий стартап»** (2025)
- 🏢 Резиденты **IT Park Казань** (площадка 52)
- Полная роль: генеральный директор + backend разработчик + проектный менеджер + аналитик
- Стек: Go (REST API), PostgreSQL, бизнес-аналитика, финансовое моделирование
